...
- `DOCS/03-messaging.md` — canonical streams, subjects, and envelope contract (also covers claim-check)
- `DOCS/08-telegram-sequence.md` — concrete Telegram inbound execution path
- `DOCS/03-messaging.md` — canonical streams, subjects, and envelope contract
- `DOCS/04-workflows.md` — trigger consumer and action execution model
- `DOCS/02-infrastructure-deployment.md` — support services and deployment models
