...
> Para la documentación canónica de arquitectura ver `DOCS/es/arquitectura/`. Este documento es un resumen orientativo.
...
Ver `DOCS/es/arquitectura/02-diseño-de-mensajes.md` para el contrato completo.
