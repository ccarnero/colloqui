...
> canónica del bus es [`DOCS/03-NATS-JETSTREAM.md`](../../../DOCS/03-NATS-JETSTREAM.md).
...
Si sos de **Infra**, empezá por `01-service-bus.md` y `05-seguridad.md`. Después revisá `04-claim-check.md` por las implicancias de storage. La referencia operacional está en `DOCS/03-NATS-JETSTREAM.md`.
