...
- [Platform Architecture](./01-platform-architecture.md) — Visual high-level overview
- [Workflow Engine](./04-workflows.md) — Trigger and action execution internals
- [Common Patterns](./09-patterns.md) — Pseudocode recipes
