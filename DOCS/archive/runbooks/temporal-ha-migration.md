...
Class: RECORD
Summary: The one-time 2026-05-22 migration from temporalio/auto-setup to a 4-role HA topology — since reverted, so this documents a configuration the cluster no longer runs.
...
> [`DOCS/runbooks/temporal.md`](../../runbooks/temporal.md).
>
