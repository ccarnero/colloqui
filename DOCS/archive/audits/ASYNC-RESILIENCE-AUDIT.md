...
Class: RECORD
Summary: 2026-07-07 audit of whether the platform's async 'submit then poll' paths survive executions longer than an HTTP timeout; origin of the G7 ackWait census guard.
Status: historical
