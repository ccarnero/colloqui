...
Class: RECORD
Summary: 2026-06-20 map of the platform's three cache layers (cache-service L1/L2, per-service Redis, in-memory) and which one actually carries the hot path.
Status: historical
