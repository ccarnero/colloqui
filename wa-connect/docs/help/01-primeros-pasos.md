# Primeros Pasos — WA Connect

## Qué es WA Connect

WA Connect es tu plataforma propia para gestionar líneas de atención al cliente por WhatsApp. Conectás tu número de WhatsApp Business y desde el dashboard podés ver conversaciones, responder mensajes y enviar templates — todo sin depender de plataformas externas.
