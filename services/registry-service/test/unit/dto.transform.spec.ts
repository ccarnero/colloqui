...
import * as canaryDto from "../../src/modules/canary/canary.dto";
import * as routesDto from "../../src/modules/routes/routes.dto";
import * as servicesDto from "../../src/modules/services/services.dto";
...
const PAYLOAD_OVERRIDES: Record<string, Record<string, unknown>> = {
  RegisterServiceDto: {
    // Custom validator: values must be strings or `{ secretKeyRef }`.
    envVars: {
...
describe("registry-service DTOs survive the production ValidationPipe", () => {
