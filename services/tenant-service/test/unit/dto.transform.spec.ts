...
import * as tenantDto from "../../src/modules/tenants/tenant.dto";
...
const DTO_MODULES: Record<string, unknown>[] = [tenantDto];
...
describe("tenant-service DTOs survive the production ValidationPipe", () => {
