...
import * as cacheDto from "../../src/modules/cache/cache.dto";
...
const DTO_MODULES: Record<string, unknown>[] = [cacheDto];
...
describe("cache-service DTOs survive the production ValidationPipe", () => {
