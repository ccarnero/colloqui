...
@Component({
  selector: "app-yoizenclaw-agent-overview",
  standalone: true,
...
export class YoizenclawAgentOverviewComponent implements OnInit {
  ...
  protected goConfigure(): void {
    void this.router.navigate(["/yoizenclaw/agents", this.agentId, "configure"]);
  }
}
