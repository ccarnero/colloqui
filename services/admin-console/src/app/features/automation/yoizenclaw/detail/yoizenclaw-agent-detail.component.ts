...
@Component({
  selector: "app-yoizenclaw-agent-detail",
  standalone: true,
...
export class YoizenclawAgentDetailComponent {
  ...
  protected goConfigure(): void {
    void this.router.navigate(["/yoizenclaw/agents", this.id(), "configure"]);
  }
