...
export const SELECTION_BUILTIN_TOOLS: IAgentEditorSelection = {
  kind: "builtin-tools",
};
export const SELECTION_MCP_SERVERS: IAgentEditorSelection = {
  kind: "mcp-servers",
};
export const SELECTION_VARIABLES: IAgentEditorSelection = {
  kind: "variables",
};
export const SELECTION_KNOWLEDGE_BASES: IAgentEditorSelection = {
  kind: "knowledgeBases",
};
export const SELECTION_VERSIONS: IAgentEditorSelection = {
  kind: "versions",
};
