...
import type { IRateLimitStrategy } from "./strategies/rate-limit.strategy";
...
export class RateLimitService {
  ...
  /**
   * Applies the configured per-tenant rate limit algorithm and returns headers metadata.
   *
   * @param tenantId - Tenant id used in Redis key and config lookup.
   */
