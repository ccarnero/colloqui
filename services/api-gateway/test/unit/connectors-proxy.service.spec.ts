...
describe("ConnectorsProxyService", () => {
  ...
  it("proxy forwards GET with tenant header", async () => {
    ...
    const svc = moduleRef.get(ConnectorsProxyService);
