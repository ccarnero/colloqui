...
import * as adminDto from "../../src/modules/admin/admin.dto";
import * as auditProxyQueryDto from "../../src/modules/audit/audit-proxy-query.dto";
import * as authDto from "../../src/modules/auth/auth.dto";
import * as channelsGatewayDto from "../../src/modules/channels/channels-gateway.dto";
import * as webhooksGatewayDto from "../../src/modules/channels/webhooks-gateway.dto";
import * as connectorsDto from "../../src/modules/connectors/connectors.dto";
import * as registryDto from "../../src/modules/registry/registry.dto";
import * as runtimeDto from "../../src/modules/runtime/runtime.dto";
import * as tenantsDto from "../../src/modules/tenants/tenants.dto";
import * as workflowsGatewayDto from "../../src/modules/workflows/workflows-gateway.dto";
...
const PAYLOAD_OVERRIDES: Record<string, Record<string, unknown>> = {
  CacheStrategyDto: {
    // Custom validator: only `"all"` or an array of non-empty strings.
    keyQueryParams: ["probe-query-param"],
  },
};
...
const EXPECTED_VULNERABLE_FIELDS: Record<string, readonly string[]> = {
  CacheStrategyDto: ["keyQueryParams"],
  CreateAdapterDto: ["authConfig"],
  CreateAgentDto: ["model_config"],
  CreateExecutionDto: ["metadata"],
  CreateJobDto: ["payload"],
  CreateMcpServerDto: ["authConfig", "headers"],
  CreateMemoryDto: ["metadata"],
  CreateTenantBodyDto: ["configuration"],
  ExecuteWorkflowGatewayDto: ["request"],
  RegisterServiceDto: ["envVars"],
  TriggerJobDto: ["payload"],
  UpdateAdapterDto: ["authConfig"],
  UpdateAgentDto: ["model_config"],
  UpdateEnabledMcpToolsDto: ["enabled_mcp_tools"],
  UpdateJobDto: ["payload"],
  UpdateMcpServerDto: ["authConfig", "headers"],
  UpdateMemoryDto: ["metadata"],
  UpdateServiceDto: ["envVars"],
  UpdateTenantBodyDto: ["configuration"],
...
describe("api-gateway DTOs survive the production ValidationPipe", () => {
