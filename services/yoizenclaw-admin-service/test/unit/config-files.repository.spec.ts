...
const createMockSql = (
  ...
  const sql = Object.assign(mockQuery, {
...
describe("ConfigFilesRepository", () => {
  ...
  describe("findAll", () => {
    it("should return files with default pagination", async () => {
      ...
      (
        mockConnectionManager.getConnection as ReturnType<typeof vi.fn>
      ).mockReturnValue(sql);
  ...
  describe("findByPath", () => {
    ...
    it("should return null when file not found", async () => {
      ...
      const result = await repository.findByPath(
        TENANT_ID,
