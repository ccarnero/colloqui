...
describe("ConfigFilesService", () => {
  ...
  describe("findByPath", () => {
    ...
    it("should throw NotFoundException when file not found", async () => {
      ...
      expect(
        service.findByPath(TENANT_ID, "/config/nonexistent.yaml"),
  ...
  describe("createOrUpdate", () => {
    it("should create new file when path does not exist", async () => {
      const createData: ICreateConfigFileData = {
        name: "New Config",
    ...
    it("should update existing file when path exists", async () => {
      const existingFile: IConfigFile = {
        id: "existing-id",
        name: "Old Config",
      ...
      const updateData: ICreateConfigFileData = {
        name: "Updated Config",
        path: "/config/existing.yaml",
        content: "new: value",
        format: "yaml",
  ...
  describe("deploy", () => {
    it("should emit event with all active files", async () => {
      ...
      (
        mockRepository.findAllActive as ReturnType<typeof vi.fn>
      ).mockResolvedValue(mockFiles);
      (
        mockNatsPublisher.publishRuntimeConfigSync as ReturnType<typeof vi.fn>
