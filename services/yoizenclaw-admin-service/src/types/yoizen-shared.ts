...
// Runtime-facing subjects (wdocs convention: evt.{tenant}.yoizenclaw.{action}.v1)
export const YOIZENCLAW_RUNTIME_CONFIG_SYNC =
  "evt.{tenant}.yoizenclaw.config_sync.v1";
