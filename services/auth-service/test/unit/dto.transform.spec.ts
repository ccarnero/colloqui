...
import * as clientDto from "../../src/modules/clients/client.dto";
import * as publicRouteDto from "../../src/modules/public-routes/public-route.dto";
import * as tenantRoleDto from "../../src/modules/tenant-roles/tenant-role.dto";
import * as tenantUserDto from "../../src/modules/tenant-users/tenant-user.dto";
import * as tokenDto from "../../src/modules/token/token.dto";
import * as userDto from "../../src/modules/users/user.dto";
...
describe("auth-service DTOs survive the production ValidationPipe", () => {
