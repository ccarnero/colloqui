...
import * as memoryQueryDto from "../../src/modules/memory/dto/memory-query.dto";
import * as proposeMemoryDto from "../../src/modules/memory/dto/propose-memory.dto";
import * as updateMemoryDto from "../../src/modules/memory/dto/update-memory.dto";
...
const EXPECTED_VULNERABLE_FIELDS: Record<string, readonly string[]> = {
  ProposeMemoryDto: ["metadata"],
  UpdateMemoryDto: ["metadata"],
};

describe("agent-memory-service DTOs survive the production ValidationPipe", () => {
