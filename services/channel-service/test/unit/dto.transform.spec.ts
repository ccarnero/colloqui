...
import * as accountsDto from "../../src/modules/accounts/accounts.dto";
import * as autoReplyDto from "../../src/modules/auto-reply/auto-reply.dto";
...
describe("channel-service DTOs survive the production ValidationPipe", () => {
