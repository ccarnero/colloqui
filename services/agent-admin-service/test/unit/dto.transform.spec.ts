...
import * as adaptersDto from "../../src/modules/adapters/adapters.dto";
import * as agentsDto from "../../src/modules/agents/agents.dto";
import * as configFilesDto from "../../src/modules/config-files/config-files.dto";
import * as jobsDto from "../../src/modules/jobs/jobs.dto";
import * as documentsDto from "../../src/modules/knowledge-bases/documents.dto";
import * as knowledgeBasesDto from "../../src/modules/knowledge-bases/knowledge-bases.dto";
import * as mcpServersDto from "../../src/modules/mcp-servers/mcp-servers.dto";
import * as memoriesDto from "../../src/modules/memories/memories.dto";
import * as skillsDto from "../../src/modules/skills/skills.dto";
import * as createSkbDto from "../../src/modules/structured-kb/dto/create-skb.dto";
import * as querySkbDto from "../../src/modules/structured-kb/dto/query-skb.dto";
import * as updateSkbDto from "../../src/modules/structured-kb/dto/update-skb.dto";
import * as uploadSkbFileDto from "../../src/modules/structured-kb/dto/upload-skb-file.dto";
import * as systemVariablesDto from "../../src/modules/system-variables/system-variables.dto";
...
const KNOWN_MANGLED_FIELDS: Record<string, readonly string[]> = {
  /** H6 — declared `string[]`, so only object elements are destroyed. */
  UploadSKBFileDto: ["categories"],
};
...
const EXPECTED_VULNERABLE_FIELDS: Record<string, readonly string[]> = {
  CreateKnowledgeBaseDto: ["ingestion_config"],
  CreateMcpServerDto: ["authConfig", "headers"],
  CreateSystemVariableDto: ["value"],
  UpdateEnabledMcpToolsDto: ["enabled_mcp_tools"],
  UpdateKnowledgeBaseDto: ["ingestion_config"],
  UpdateMcpServerDto: ["authConfig", "headers"],
  UpdateSystemVariableDto: ["value"],
  UpdateToolDescriptionOverridesDto: ["tool_description_overrides"],
};

describe("agent-admin-service DTOs survive the production ValidationPipe", () => {
