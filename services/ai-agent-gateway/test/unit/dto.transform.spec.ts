...
import * as executionsDto from "../../src/modules/executions/executions.dto";
...
const DTO_MODULES: Record<string, unknown>[] = [executionsDto];
...
describe("ai-agent-gateway DTOs survive the production ValidationPipe", () => {
