...
YOIZENCLAW_RUNTIME_GATEWAY_ACTIONS: dict[str, str] = {
    "execution_requested": "evt.{tenant}.yoizenclaw-runtime-gateway.automation.yoizenclaw.internal.execution_requested.v1",
    "execution_started": "evt.{tenant}.yoizenclaw-runtime-gateway.automation.yoizenclaw.internal.execution_started.v1",
    "execution_completed": "evt.{tenant}.yoizenclaw-runtime-gateway.automation.yoizenclaw.internal.execution_completed.v1",
    "execution_failed": "evt.{tenant}.yoizenclaw-runtime-gateway.automation.yoizenclaw.internal.execution_failed.v1",
}
...
def build_runtime_gateway_subject(tenant: str, action: str) -> str:
    ...
    template = YOIZENCLAW_RUNTIME_GATEWAY_ACTIONS[action]
