...
describe("Platform NATS Subjects", () => {
  describe("constants", () => {
    ...
    test("AGENT_ADMIN_ONLINE follows subject convention (DOCS/messaging/service-bus.md)", () => {
      expect(AGENT_ADMIN_ONLINE).toBe(
  ...
  describe("buildPlatformSubject", () => {
    ...
    test("handles single-char tenantId", () => {
      const result = buildPlatformSubject(AGENT_ADMIN_ONLINE, "a");
      expect(result).toBe(
