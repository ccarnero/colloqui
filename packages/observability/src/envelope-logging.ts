 ...
 * canonical `EventEnvelope` (wdocs 02 §2) fields required for
 * structured logging (wdocs 06 §3.1).
 */
...
/** Required structured fields per wdocs 06 §3.1. */
 ...
 * wdocs/docs/arquitectura/06-observabilidad.md §3.1 from an envelope.
