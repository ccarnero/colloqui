...
- `docs/architecture/adr-rag-system.md` — KB and RAG system design (Phase 1-2 already implemented)
- `docs/architecture/adr-variable-system.md` — Variable system for agent I/O (complements context pipeline)
