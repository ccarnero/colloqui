...
const getToken = () => localStorage.getItem('coexistance_token')
...
const updateMetaCredentials = (accountId, metaAppId, metaAppSecret) =>
  request(`/accounts/${accountId}/meta-credentials`, {
    method: 'POST',
    body: JSON.stringify({ meta_app_id: metaAppId, meta_app_secret: metaAppSecret }),
  })
