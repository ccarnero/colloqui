# Coexistance — Contexto para v1.1
...
10. Mensajes enviados desde la consola de Meta **no aparecen** en Coexistance — es por diseño de Meta (solo manda status webhooks sin contenido). Siempre enviar desde Coexistance.
