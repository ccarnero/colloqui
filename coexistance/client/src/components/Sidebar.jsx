...
const Sidebar = ({ conversations, activeContact, onSelectContact, onRefresh, accountName }) => (
  <aside className="w-80 border-r border-gray-200 bg-white flex flex-col shrink-0">
    <div className="p-3 border-b border-gray-100 flex items-center justify-between">
      <div className="flex flex-col">
        ...
        {accountName && (
          <span className="text-xs text-gray-400 truncate max-w-48">{accountName}</span>
        )}
      </div>
      <button
        onClick={onRefresh}
