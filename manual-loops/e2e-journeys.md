...
- [x] T04 J4 toggle — attempt 1/4; G0 exit 0 (KISS guards passed), G1 exit 0 (8 passed, 1 future-task fixme skipped), Accept exit 0 (1 passed); 2× APPROVED; pending human commit, T05 remains, no blockers; tokens estimated <100k/6M across threads (exact usage unavailable).
- [ ] T05 J5 diagnose

Token ceiling: 6 M per task, every thread including the orchestrator.

- Attempts: T01 1/4; T02 1/4; T03 2/4; T04 1/4; T05 0/4.
