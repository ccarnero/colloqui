...
- `admin-console/src/app/features/channels/` —
...
**Accept**
```
grep -n "T01 findings" manual-loops/console-redesign-channels.md
```
...
- Update `admin-console/README.md`, add entry to `cowork/INDEX.md`, log the
