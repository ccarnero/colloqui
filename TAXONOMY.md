...
| 11 | subject contains `.connector-runtime.platform.endpoint.` (any OTHER kind in this family, e.g. `endpoint_call_completed`) | `connector` | `connector-invocation` | `envelope-parser.ts:198-204` |
