...
#                       Must match the Telegram channel account secret used
#                       during provisioning (default fixture: anothersecret,
#                       same as CHANNEL_APP_SECRET below). k6 sends this as
#                       X-Telegram-Bot-Api-Secret-Token; a mismatch yields
#                       signature_mismatch and zero sink deliveries.
#
