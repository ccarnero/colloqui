...
from src.jobs.actions.function_action import execute_function, get_default_functions
...
class JobExecutor:
    ...
    - pipeline: Execute multi-step pipelines
    """
    ...
    async def execute(
        ...
        if job.action_type == "llm_call":
            ...
            return await execute_pipeline(job, execution)
        else:
