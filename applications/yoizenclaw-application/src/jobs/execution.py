...
from src.shared.telemetry import get_tracer, record_job_execution, record_job_duration
...
class JobExecutionEngine:
    ...
    async def _report_execution_status(
        ...
        """
        try:
            from src.interfaces.nats_bridge import publish_job_execution_status
