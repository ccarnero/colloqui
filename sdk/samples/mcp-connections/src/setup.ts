...
const MCP_SERVER_DESCRIPTION =
  ...
  "Example MCP server created by sdk/samples/mcp-connections (fake endpoint, demonstrates auth/test/tools/agent-wiring call shapes)";
...
const AGENT_DESCRIPTION =
  ...
  "Demo agent wired to a subset of an MCP server's tools, created by sdk/samples/mcp-connections";
